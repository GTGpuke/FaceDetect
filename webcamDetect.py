...
import cv2 #On importe OpenCV pour le traitement de la webcam et l'affichage final.
...
#Traiement de la webcam.
while(cap.isOpened()):
	_, frame = cap.read() #On lit chaque frame de la webcam tant que celle ci est ouverte.
